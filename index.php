...
<header>
    <nav class="navbar navbar-expand-lg">
        <div class="container-lg">
            ...
            <button id="but_001" class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="textoswe">
                        ...
                        <button type="button" class="comenzar btn" data-bs-toggle="modal"
                ...
                <div class="col-md-6">
                    <div class="video">
                        <iframe width="100%" height="350"
                            src="https://www.youtube.com/embed/eyCXSOkZukI?autoplay=0&mute=0&controls=0"
...
<section class="wavedos">
    <div class="wave2" style="height: 150px; overflow: hidden;"><svg viewBox="0 0 500 150" preserveAspectRatio="none"
            style="height: 100%; width: 100%;">
    ...
    <section class="contacto" id="contacto">
        <div class="card-body secciones_body">
            <div class="row">
                <div class="col-md-7">
                    <div class="form">
                        ...
                        <p>Somos una consultoría emergente de desarrollo web,
                            ...
                            nos especializamos en ofrecer servicios de consultoría personalizados para ayudar a nuestros
                            clientes a
                            aprovechar al máximo su presencia en línea. Desde el diseño inicial hasta la implementación
                            y el soporte continuo,
                            estamos comprometidos a ofrecer soluciones de desarrollo web de alta calidad que impulsen el
                ...
                <div class="col-md-5">
                    <form action="/Php/procesoDeDatos.php" method="post" class="formData mb-5">
                        <input type="text" name="nombre" required placeholder="Tu nombre o el de tu empresa"
